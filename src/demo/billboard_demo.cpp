...
void billboard_demo() {
	...
	vertex_color_model_ptr->addInstance("CUBE", Instance(VERTEX_COLOR_NAME, vertex_color_set_up_shader, vec3(), quat(), vec3(0.2f)));
	...
	vertex_texture_model_ptr->addInstance("Billboard", VertexTextureInstance(BILLBOARD_2D_NAME, TEXTURE_NAME, billboard_less_set_up_shader, vec3(0, 0.5, 0), quat(),
	                                      vec3(1, 0.125, 0)));
	// vertex_texture_model_ptr->addInstance("Billboard", VertexTextureInstance(BILLBOARD_FIX_NAME, TEXTURE_NAME, billboard_less_set_up_shader, vec3(0, 0.5, 0), quat(),
	//                                       vec3(0.2, 0.05, 0)));
	// vertex_texture_model_ptr->addInstance("Billboard", VertexTextureInstance(BILLBOARD_3D_NAME, TEXTURE_NAME, billboard_more_set_up_shader, vec3(0, 0.5, 0), quat(),
	//                                       vec3(1, 0.125, 0)));
	// vertex_texture_model_ptr->addInstance("Billboard", VertexTextureInstance(BILLBOARD_VERT_NAME, TEXTURE_NAME, billboard_more_set_up_shader, vec3(0, 0.5, 0), quat(),
	//                                       vec3(1, 0.125, 0)));
